...
// 			gSvc := gateway.NewGatewayService(client, nil, newKS("", nil, nil, nil))
//
// 			// run
...
// 			eetCA:  fscr.NewCAService(nil, icaCertPool),
// 			ks:     newKS(okCertID, []byte{}, cert, pk),
// 			expErr: gateway.ErrCertificateGet,
// 		},
// 		{
...
// 			expErr: gateway.ErrRequestBuild,
// 		},
// 		{
// 			name:   "invalid url",
// 			certID: okCertID,
...
// 			eetCA:  fscr.NewCAService(nil, icaCertPool),
// 			ks:     newKS(okCertID, []byte{}, cert, pk),
// 			expErr: gateway.ErrFSCRConnection,
// 		},
// 		{
...
// 			ks:     newKS(okCertID, []byte{}, cert, pk),
// 			expErr: gateway.ErrFSCRResponseVerify,
// 		},
// 	}
//
// 	for _, tc := range tests {
// 		t.Run(tc.name, func(t *testing.T) {
// 			// construct a service
// 			gSvc := gateway.NewGatewayService(tc.client, tc.eetCA, tc.ks)
//
// 			// run
